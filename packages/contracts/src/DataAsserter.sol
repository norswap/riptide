...
contract DataAsserter {
    ...
    constructor(address _defaultCurrency, address _optimisticOracleV3) {
        ...
        // _optimisticOracleV3 is used to locate the address of UMA Optimistic Oracle V3. Address of OptimisticOracleV3 
        //contact can be fetched from the relevant networks file, if you are on a live network, or you can provide your 
        // own contract instance if deploying UMA Oracle contracts in your own sandboxed testing environment.
